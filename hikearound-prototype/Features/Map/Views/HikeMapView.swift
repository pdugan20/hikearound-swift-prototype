    ...
    .mapStyle(
      .standard(
        ...
        pointsOfInterest: .excluding([
          .store, .restaurant, .gasStation, .hotel, .nightlife, .airport, .amusementPark, .aquarium,
          .atm, .bakery, .bank, .brewery, .cafe, .carRental, .evCharger, .fitnessCenter,
          .foodMarket, .laundry, .library, .marina, .movieTheater, .museum, .pharmacy, .postOffice,
          .school, .stadium, .store, .theater, .university, .winery, .zoo,
        ]), showsTraffic: false)
    )
