...
extension Hike {
  static let sampleHikes = [
    Hike(
      ...
      description:
        "A scenic trail offering panoramic views of the valley below. "
        + "Perfect for sunrise hikes with moderate elevation gain throughout.",
    ...
    Hike(
      name: "Redwood Loop",
      description:
        "Wind through ancient redwood groves on this family-friendly trail. Mostly shaded with gentle slopes.",
    ...
    Hike(
      ...
      description:
        "Challenging climb to the highest peak in the region. Experienced hikers only. Bring plenty of water.",
    ...
    Hike(
      ...
      description:
        "Stunning ocean views along dramatic cliffs. Watch for migrating whales during winter months.",
    ...
    Hike(
      ...
      description:
        "A beautiful trail leading to a pristine alpine lake. Great for swimming in summer months.",
